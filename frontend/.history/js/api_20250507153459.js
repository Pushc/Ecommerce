...
async function loadProducts()
{
    try {
        ...
        response.forEach((element) => {
            ...
            }else if(element.category === "Electronics" || element.category === "Television" || element.category === "Washing Machine" || element.category === "Smart Watch" || element.category === "Printer" || element.category === "Tab"){
