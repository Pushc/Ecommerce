...
function orderSummary(){
  ...
  const gstTotal = document.getElementById('gst');
  gstTotal.innerText=gst.toFixed(2);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  payButton.addEventListener("click", function () {
    ...
    fetch("https://payment-service-66x4.onrender.com/api/payment/createOrder", {
      method: "POST",
      ...
      .then(data => {
        const options = {
          ...
          handler: function (response) {
            fetch("https://payment-service-66x4.onrender.com/api/payment/updateOrder", {
              method: "POST",
