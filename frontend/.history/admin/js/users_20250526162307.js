const API_BASE = "https://ecommerce-service-niko.onrender.com";
...
function fetchUsers() {
  ...
  fetch("https://ecommerce-service-niko.onrender.com/admin/users", {
    headers: {
    ...
    users.forEach(user => {
      ...
      row.innerHTML = `
        ...
        <td>
          ...
          <button style="color: white; background: #23ab23;" onclick="openEditUserModal(${user.id})">
...
function deleteUser(userId) {
  ...
  fetch(`https://ecommerce-service-niko.onrender.com/admin/users/${userId}`, {
    method: "DELETE",
    headers: {
      Authorization: `Bearer ${token}` // Send token for authentication
    },
