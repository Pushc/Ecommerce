const BASE_URL="https://ecommerce-service-niko.onrender.com";
                ...
                <div class="col-lg-4 col-md-6 mb-5">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Add to Cart Button -->
                            <button class="btn btn-primary w-100 mb-2" onclick="addToCart(${item.id},'${item.name}',${item.price},'${item.imageUrl}')">Add to Cart</button>
